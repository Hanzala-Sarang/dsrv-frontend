  ...
  const features = [
    {
      ...
      description: "Our advanced formula tackles even the toughest stains, from food spills to grass marks.",
      icon: (
    ...
    },
    {
      ...
      description: "Gentle yet effective cleaning that preserves fabric quality and extends the life of your clothes.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: "Unique fragrance technology keeps your clothes smelling fresh and clean for days.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: "Biodegradable ingredients that deliver powerful cleaning while being kinder to the planet.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: "Special brightening agents keep colors vibrant and whites dazzling wash after wash.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: "Concentrated formula means you need less powder per wash, saving you money in the long run.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
